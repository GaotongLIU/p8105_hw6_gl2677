...
variance in prediction error of fit1 is larggest, and that of fit2 and
my\_fit is quite similar. My fit model `bwt ~ babysex + blength +
gaweeks + bhead` is the best among three models.
...
<img src="p8105_hw6_gl2677_files/figure-gfm/plot estimate-2.png" width="90%" />
  ...
  - The 95% confidence interval for `log(beta_0*beta_1)` is (1.966,
    2.059)
